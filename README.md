...
## 1. Research question
Does company-specific ("residual") short-term price pressure in liquid U.S. stocks still reverse enough, after realistic exchange-member costs, to be traded profitably with closing-auction orders (market-on-close / limit-on-close), when moves caused by material company news are filtered out ex ante?
